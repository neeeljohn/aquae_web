...
<head>
    ...
    <title>Scheduled Delivery- Aquae</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Schedule Delivery</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody id="request_scheduled_delivery">
                                </tbody>
                            </table>
                            <div id="requestschedDet">
                            </div>
                            <div id="messCus">
                            </div>
                             <div id="assignBoy">
                            </div>
                            <div id="declinescheds">
                            </div>
                            <!-- /.table-responsive -->
