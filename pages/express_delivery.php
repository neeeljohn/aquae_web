...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="express_delivery.php"><i class="fa fa-send fa-fw"></i> Express Delivery<span class="badge"></span></a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Express Orders</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <table class="table table-striped table-bordered" style="width:100%" >
                              ...
                              <tbody id="expressnessingness">

                              </tbody>
                                <div id="detalye"></div>
                                <div id="express_ordering"></div>

                                <div id="modalforcancelation"></div>
                            </table>
